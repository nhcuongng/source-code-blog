...
export default function PostTemplate({ data, pageContext, ...props }) {
  ...
  useEffect(() => {
    ...
    commentScript.setAttribute('repo', 'nhcuongng/comments') // CHANGE THIS if you're just going to clone this repo and use the code. Do not test your code using my repo.
